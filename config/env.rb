...
DEPLOY_TTL = (ENV['DEPLOY_TTL'] || 20*60)  # 20 Minutes 
...
LIMIT_ERRORS = (ENV['LIMIT_ERRORS'] || 3).to_i
APPS_WAKEUP = (ENV['APPS_WAKEUP'] || 10).to_i

LOGENTRIES_ALERT_MESSAGE = ENV['LOGENTRIES_ALERT_MESSAGE'] 
LOGENTRIES_USER = ENV['LOGENTRIES_USER']
LOGENTRIES_PASSWORD = ENV['LOGENTRIES_PASSWORD']
